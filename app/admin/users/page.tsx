...
const AdminUsersPage = () => {
  return (
    <div className="space-y-6">
      <section className="glass-morphism relative overflow-hidden rounded-3xl border border-white/10 p-5 sm:p-9">
        ...
        <div className="relative z-10">
          ...
          <h1 className="mt-3 font-bebas-neue text-4xl tracking-[0.08em] text-white xs:text-5xl sm:text-6xl">
            All Users
          </h1>
          <p className="mt-3 max-w-2xl wrap-break-word text-sm text-light-100/80 sm:text-base">
      ...
      <section className="grid gap-4 sm:gap-6 xl:grid-cols-[1.35fr_1fr]">
        <article className="glass-morphism rounded-3xl border border-white/10 p-5 sm:p-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 className="font-bebas-neue text-2xl tracking-[0.08em] text-white sm:text-3xl">
              User Growth
            </h2>
            <span className="w-fit rounded-full border border-primary-admin/40 bg-primary-admin/15 px-3 py-1 text-xs text-primary-admin">
              Last 6 Months
            </span>
          </div>

          <div className="mt-6 rounded-2xl border border-white/10 bg-dark-300/60 p-3 sm:p-4">
            <svg
              viewBox="0 0 640 260"
      ...
      <section className="glass-morphism rounded-3xl border border-white/10 p-5 sm:p-8">
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 break-all text-xs text-light-100/80">
                    {user.email}
                  </p>
                </div>
                <span
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-light-100/80">
                <p>Role: {user.role}</p>
